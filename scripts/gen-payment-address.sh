...
cardano-cli address key-gen \
        --verification-key-file testnet/payment04.vkey \
        --signing-key-file testnet/payment04.skey

cardano-cli address build \
        --payment-verification-key-file testnet/payment04.vkey \
        --out-file testnet/payment04.addr \
